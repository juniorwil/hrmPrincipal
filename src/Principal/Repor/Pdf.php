...
function FPDF($orientation='P', $unit='mm', $size='A4')
{
	...
	if(defined('FPDF_FONTPATH'))
	{
        ...
        $this->fontpath = "./public/font/"; // NISSI
	// Core fonts
...
function AddPage($orientation='', $size='')
{
	...
	// Page header
	$this->InHeader = true;
        $this->Header(); // ORIGINAL DE LA LIBRERIA
...
function Header() // MODIFICACIONE EN LA FUNION NISSI, ( AGREGADO PARAMETROS A LA CABECERA )
{
